...
app.use(cors({
    origin: ['http://13.220.197.127:8014', 'http://127.0.0.1:5501', 'http://127.0.0.1:5503','http://13.220.197.127:8015'],
    methods: ['GET', 'POST'],
...
app.listen(port, () => {
    console.log(`Server running at http://13.220.197.127:${port}`);
});